...
!!! danger
    It is **strongly recommended** that you backup your database before excuting this query and that you perform this in a non-production environment to identify any potential issues prior to updating your production environment.
