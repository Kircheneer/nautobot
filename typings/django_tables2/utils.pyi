...
class Sequence(list):
    ...
    specified.
    """
    def expand(self, columns):  # -> Self@Sequence:
        """
...
class OrderBy(str):
    ...
    QUERYSET_SEPARATOR = ...
    def __new__(cls, value):  # -> Self@OrderBy:
        ...
    @property
    def bare(self):  # -> OrderBy | Self@OrderBy:
        """
        Returns:
...
class OrderByTuple(tuple):
    ...
    """
    def __new__(cls, iterable):  # -> Self@OrderByTuple:
        ...
    ...
    @property
    def opposite(self):  # -> Self@OrderByTuple:
        """
...
class Accessor(str):
    ...
    LOOKUP_ERROR_FMT = ...
    def __new__(cls, value):  # -> Self@Accessor:
        ...
    ...
    def penultimate(self, context, quiet=...):  # -> tuple[Unknown, str]:
        """
...
def segment(sequence, aliases):  # -> Generator[tuple[Unknown | OrderBy, ...], Any, None]:
    """
...
def signature(fn):  # -> tuple[tuple[Unknown, ...], str | None]:
    """
    Returns:
...
def computed_values(d, kwargs=...):  # -> dict[Unknown, Unknown]:
    """
