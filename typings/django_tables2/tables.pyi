...
"""
from typings.django_tables2.columns import BoundColumns
from typings.django_tables2.rows import BoundRows
...
class DeclarativeColumnsMetaclass(type):
    ...
    """
    def __new__(mcs, name, bases, attrs):  # -> Self@DeclarativeColumnsMetaclass:
        ...
...
class Table(metaclass=DeclarativeColumnsMetaclass):
    ...
    def as_html(self, request):  # -> Any:
        """
        Render the table to an HTML table, adding `request` to the context.
        """
        ...

    def as_values(self, exclude_columns=...):  # -> Generator[list[str], Any, None]:
        """
    ...
    def page_field(self, value):  # -> None:
        ...
    def paginate(self, paginator_class=..., per_page=..., page=..., *args, **kwargs):  # -> Self@Table:
        """
    ...
    def template_name(self, value):  # -> None:
        ...
    @property
    def paginated_rows(self):  # -> QuerySet[Any] | BoundRows:
        """
...
def table_factory(model, table=..., fields=..., exclude=..., localize=...):  # -> Any:
    """
