...
class Column:
    ...
    link = ...
    _explicit = ...
    def __init__(self, verbose_name=..., accessor=..., default=..., visible=..., orderable=..., attrs=..., order_by=..., empty_values=..., localize=..., footer=..., exclude_from_export=..., linkify=..., initial_sort_descending=...) -> None:
        ...
