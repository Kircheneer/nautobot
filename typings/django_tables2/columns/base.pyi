...
class Library:
    ...
    def column_for_field(self, field, **kwargs):  # -> None:
        """
...
class LinkTransform:
    ...
    def get_attrs(self, **kwargs):  # -> AttributeDict:
        ...
    def __call__(self, content, **kwargs):  # -> SafeText:
        ...
...
class Column:
    ...
    def footer(self, bound_column, table):  # -> Literal[''] | None:
    ...
    def order(self, queryset, is_descending):  # -> tuple[Unknown, Literal[False]]:
        """
    ...
    @classmethod
    def from_field(cls, field, **kwargs):  # -> Self@Column | None:
        """
...
class BoundColumn:
    ...
    @property
    def attrs(self):  # -> dict[Unknown, Unknown]:
        """
    ...
    @property
    def header(self):  # -> SafeData | str | None:
    ...
    @property
    def verbose_name(self):  # -> SafeData | str | None:
        """
...
class BoundColumns:
    ...
    def iternames(self):  # -> Generator[Unknown, None, None]:
        ...
    def names(self):  # -> list[Unknown]:
        ...
    def iterall(self):  # -> Generator[Unknown, None, None]:
        """
    ...
    def all(self):  # -> list[Unknown]:
        ...
    def iteritems(self):  # -> Generator[tuple[Unknown, Unknown], Any, None]:
        """
    ...
    def items(self):  # -> list[tuple[Unknown, Unknown]]:
        ...
    def iterorderable(self):  # -> Generator[Unknown, None, None]:
        """
    ...
    def itervisible(self):  # -> Generator[Unknown, None, None]:
        """
